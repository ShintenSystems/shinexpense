...
<div class="form-group">
<label for="deadline">Deadline<span class="text-red">*</span></label>
<input type="date" placeholder=" Deadline" class="form-control" id="deadline" name="deadline" required value="<?php echo isset($data->deadline)?date("Y-m-d",strtotime($data->deadline)):date("Y-m-d",strtotime("now"));?>"  >
</div>

<div class="form-group">
<label for="tantou">Tantou</label>
<?php echo selectBoxDynamic("tantou","users","name",isset($data->tantou) ?$data->tantou : "");?>
</div>

<div class="form-group">
<label for="action_status">Status</label>
<?php echo selectBoxDynamic("action_status","item_status","action_status",isset($data->action_status)?$data->action_status:"");?>
</div>
