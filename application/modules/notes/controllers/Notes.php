...
class Notes extends CI_Controller {
	...
	public function add_edit() {	
		...
		if($this->input->post('id')) {
			...
			//log_message('debug',echo("This is my debug message")); 
			//log_message('debug',print_r($data,TRUE)); 
...
array( 'db' => '`notes`.`deadline`', 'dt' => 5, 'field' => 'deadline' ),
array( 'db' => '`users`.`tantou`', 'dt' => 6, 'field' => 'name' ),
array( 'db' => '`item_status`.`action_status`', 'dt' => 7, 'field' => 'action_status' ),
array( 'db' => '`notes`.`notes_id`', 'dt' => 8, 'field' => 'notes_id' ));
