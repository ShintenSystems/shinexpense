<?php 
  ...
  <tr>
<?php if($value->category_name != 'Monthly Contribution') { ?>
<td><input type="checkbox" name="selData" value="<?php echo $value->$tab_id; ?>"></td> 
<?php } else {  ?> 
<td><input type="hidden" name="selData" value="<?php echo $value->$tab_id; ?>"></td> 
<?php } ?>
...
<td><?php 
    if($value->category_name != 'Monthly Contribution') {
