...
class Dashboard_model extends CI_Model {       
	...
	/**
      * This function is get income balance data 
      * @param : $id is value of income_id
      */
	public function Get_total_received_amt() {
		 $this->db->select('SUM(amount) amount_received');
		 $this->db->from('income');
	...
	/**
      ...
      * @param : $id is value of income_id
      */
	public function Get_total_spent_amt() {
		 $this->db->select('SUM(amount) amount_spent');
